...
export default async function VendorsPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-4xl px-4 py-10">
      ...
      <h1 className="mt-2 font-serif text-2xl font-medium text-ink">Proveedores</h1>
      <p className="mt-1 text-sm text-ink-muted">
        Tu libreta de contactos (catering, foto, música, flores, etc.), reutilizable en todos tus
        eventos.
      </p>
      ...
      <section className="mt-6">
        <h2 className="mb-3 font-serif text-lg font-medium text-ink">Agregar proveedor</h2>
        <form
          action={createVendor}
      ...
      <section className="mt-8">
        <h2 className="mb-3 font-serif text-lg font-medium text-ink">
          Tus proveedores ({vendors.length})
        </h2>
        {vendors.length === 0 ? (
          <p className="text-sm text-ink-muted">Todavía no agregaste ningún proveedor.</p>
        ) : (
